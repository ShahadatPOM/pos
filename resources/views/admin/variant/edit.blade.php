                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="fkfood_id">
                                            ...
                                            <option @if($food->fkfood_id == $food->id) selected @endif value="{{ $food->id }}">{{ $food->foodName }}</option>                                                
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Variant Name</label>
                                        <input type="text" class="form-control" value="{{ $variant->variantName }}" name="variantName" placeholder="Variant Name">
                                        @error('variantName')
                                    ...
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input type="number" class="form-control" value="{{ $variant->price }}" name="price" placeholder="Add price">
                                        @error('price')
                                        <div class="alert alert-danger mt-2 mb-2">{{ $message }}</div>
                                        @enderror
                                    </div>
