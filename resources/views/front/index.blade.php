...
<head>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="{{asset('front_temp/images/favicon.ico')}}" type="image/x-icon" />
    <link rel="apple-touch-icon" href="{{asset('front_temp/images/apple-touch-icon.png')}}">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{('front_temp/css/bootstrap.min.css')}}">
    <!-- Site CSS -->
    <link rel="stylesheet" href="{{('front_temp/css/style.css')}}">
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="{{('front_temp/css/responsive.css')}}">
    <!-- color -->
    <link id="changeable-colors" rel="stylesheet" href="{{('front_temp/css/colors/orange.css')}}" />

    <!-- Modernizer -->
    <script src="{{('front_temp/js/modernizer.js')}}"></script>
...
<body>
                            ...
                            <div class="navbar-header">
                                ...
                                <div class="logo">
                                    <a class="navbar-brand js-scroll-trigger logo-header" href="#">
                                        <img style="margin-top: 20px; margin-left: 120px; background: #fff" src="{{asset('front_temp/images/logo.png')}}" alt="">
                                        {{--  <h3 style="color: #ffffff">LOGO</h3>  --}}
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="about-images">
                            <img class="about-main" src="{{asset('front_temp/images/about-main.jpg')}}" alt="About Main Image">
                            <img class="about-inset" src="{{asset('front_temp/images/about-inset.jpg')}}" alt="About Inset Image">
                        </div>
                    </div>
                </div>
                <!-- end col -->
    ...
    <div class="special-menu pad-top-100 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title color-white text-center"> Todays Special </h2>
                    ...
                    <div class="special-box">
                        <div id="owl-demo">
                            <div class="item item-type-zoom">
                                ...
                                <div class="item-img">
                                    <img src="{{asset('front_temp/images/special-menu-1.jpg')}}" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="{{asset('front_temp/images/special-menu-2.jpg')}}" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="{{asset('front_temp/images/special-menu-3.jpg')}}" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <p class="title-caption text-center">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable. </p>
                    </div>
                    <div class="tab-menu">
                        ...
                        <div class="slider slider-single">
                            <div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-01.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>GARLIC BREAD</h3>
                                            <p>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-02.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>MIXED SALAD</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-03.jpg')}}" alt="" class="img-responsive">
                                        <div>
                            ...
                            <div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-04.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-05.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-06.jpg')}}" alt="" class="img-responsive">
                                        <div>
                            ...
                            <div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-07.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-08.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>CHICKEN TIKKA MASALA</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-09.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>CHICKEN TIKKA MASALA</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                            ...
                            <div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('front_temp/images/menu-item-thumbnail-10.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>MEAT FEAST PIZZA</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                    ...
                    <div class="team-box">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="{{asset('front_temp/images/staff-01.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>John Doggett</h3>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="{{asset('front_temp/images/staff-02.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="text-col">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="{{asset('front_temp/images/staff-03.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>Monica Reyes</h3>
                                        <p>Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Aenean commodo ligula.</p>
                        ...
                        <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#1">
                                    <img src="{{asset('front_temp/images/gallery_01.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#2">
                                    <img src="{{asset('front_temp/images/gallery_02.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#3">
                                    <img src="{{asset('front_temp/images/gallery_03.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#4">
                                    <img src="{{asset('front_temp/images/gallery_04.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#5">
                                    <img src="{{asset('front_temp/images/gallery_05.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#9">
                                    <img src="{{asset('front_temp/images/gallery_06.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#10">
                                    <img src="{{asset('front_temp/images/gallery_07.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#11">
                                    <img src="{{asset('front_temp/images/gallery_08.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#12">
                                    <img src="{{asset('front_temp/images/gallery_09.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#13">
                                    <img src="{{asset('front_temp/images/gallery_10.jpg')}}" alt="" />
                                </a>
                    ...
                    <div class="blog-box clearfix">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="{{asset('front_temp/images/featured-image-01.jpg')}}" alt="" />
                                        <div class="overlay">
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="{{asset('front_temp/images/featured-image-02.jpg')}}" alt="" />
                                        <div class="overlay">
                                            <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="{{asset('front_temp/images/featured-image-03.jpg')}}" alt="" />
                                        <div class="overlay">
                                            <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="{{asset('front_temp/images/featured-image-04.jpg')}}" alt="" />
                                        <div class="overlay">
                                            <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                ...
                <div class="panel-pricing-in">
                    ...
                    <div class="col-md-4 col-sm-4 text-center">
                        <div class="panel panel-pricing">
                            <div class="panel-heading">
                                <div class="pric-icon">
                                    <img src="{{asset('front_temp/images/store.png')}}" alt="" />
                                </div>
                                <h3>Basic</h3>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-4 text-center">
                        <div class="panel panel-pricing">
                            <div class="panel-heading">
                                <div class="pric-icon">
                                    <img src="{{asset('front_temp/images/food.png')}}" alt="" />
                                </div>
                                <h3>Pro</h3>
                            </div>
                            <div class="panel-body text-center">
                    ...
                    <div class="col-md-4 col-sm-4 text-center">
                        <div class="panel panel-pricing">
                            <div class="panel-heading">
                                <div class="pric-icon">
                                    <img src="{{asset('front_temp/images/coffee.png')}}" alt="" />
                                </div>
                                <h3>Platinum</h3>
                            </div>
                            <div class="panel-body text-center">
        ...
        <div class="footer-box pad-top-70">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <p>
                                    ...
                                    <span><a href="#">support@rifatfood.com</a></span>
                                </p>
                            </div>
                            <!-- end footer-box-c -->
                        </div>
            ...
            <div id="copyright" class="copyright-main">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h6 class="copy-title"> Copyright &copy; 2020 Online Food Order and POS System is develop by Rifat </h6>
                        </div>
                    </div>
                    <!-- end row -->
                </div>
    ...
    <!-- ALL JS FILES -->
    <script src="{{asset('front_temp/js/all.js')}}"></script>
    <script src="{{asset('front_temp/js/bootstrap.min.js')}}"></script>
    <!-- ALL PLUGINS -->
    <script src="{{asset('front_temp/js/custom.js')}}"></script>
</body>
